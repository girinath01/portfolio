...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Girinath K — AI & Data Science student building ML, computer vision, and Python projects." },
      { name: "author", content: "Girinath K" },
